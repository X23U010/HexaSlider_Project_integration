...
<title>HexaSlider ver.β1.0 ポータルサイト</title>
...
<body>
	...
	<header>
		<div class="logo">HexaNexas.web ver.β1.0</div>
		<nav>
	...
	<main class="container">
		...
		<section id="home" class="page active">
			<div class="hero">
				<h1>WELCOME TO THE HexaNexas！</h1>
			...
			<div class="news-summary" onclick="switchPage('news')">
				<span class="badge update">UPDATE</span> <span class="date"
					id="pickup-date">2026.06.18</span>
		...
		<section id="news" class="page">
			...
			<div class="news-list" id="news-list-container">
				<div class="news-item">
					<span class="badge update">UPDATE</span> <span class="date">2026.06.18</span>
					<h3>【開発ブログ】αテスト版の譜面システムと楽曲制作の裏側を公開！</h3>
					<p>現在開発中の音ゲー『HexaSlider』の譜面プレビューと, 第一弾収録予定の書き下ろし楽曲の情報を公開しました...</p>
				</div>
				<div class="news-item">
					<span class="badge event">EVENT</span> <span class="date">2026.06.10</span>
		...
		<section id="mypage" class="page">
			...
			<div class="user-card">
				...
				<div class="user-info">
					<div class="user-name">
						音ゲー太郎 <span class="user-id">ID: <span id="display-user-id">12345678</span></span>
					</div>
					<div class="user-stats">
						<span>RANK: <strong id="user-rank">99</strong></span> <span>所持通貨:
							<strong id="user-coin">0</strong> CP
						</span>
					</div>
				</div>
			</div>
			...
			<div class="section-title">🛍️購入履歴 (最新50件 / 30日間保持)</div>
			<div id="mypage-history-list-container" class="history-container">
			</div>
		</section>
			...
			<div class="shop-grid">
				...
				<div class="shop-card featured">
					...
					<button class="btn-buy"
						onclick="addToCart('9,9999 CP', 99999, 99999)">カートに入れる</button>
				</div>
			</div>
		</section>
			...
			<div class="admin-grid">
				<div class="admin-card">
					...
					<div class="form-group">
						<label>対象ユーザーID</label> <input type="text" id="admin-user-id"
					...
					<div class="form-group">
						...
						<div style="display: flex; gap: 10px;">
							...
							<button type="button" class="btn-secondary"
								...
								onclick="clearAdminInput('rank')">0にする</button>
						</div>
					</div>
					<div class="form-group">
						<label>変更後の 所持通貨 (MDP)</label>
						<div style="display: flex; gap: 10px;">
							<input type="number" id="admin-user-coin" value="0"
								style="flex: 1;">
							<button type="button" class="btn-secondary"
								style="padding: 5px 15px; font-size: 13px;"
								onclick="clearAdminInput('coin')">0にする</button>
						</div>
					</div>
				...
				<div class="admin-card">
					...
					<p style="font-size: 13px; color: #ccc; margin-bottom: 15px;">
						ブラウザの localStorage に保存されている全ユーザー共通の購入履歴データを一括でクリアします。</p>
					<button class="btn-admin-submit" style="background: #e74c3c;"
						onclick="clearPurchaseHistory()">購入履歴をすべて削除</button>
				</div>

				<div class="admin-card">
					<h3>📢 新規ニュース投稿</h3>
					<div class="form-group">
						<label>ニュースタイトル</label> <input type="text" id="admin-news-title"
							placeholder="【重要】サーバーメンテナンスのお知らせ">
					</div>
					<div class="form-group">
						<label>タグの種類</label> <select id="admin-news-tag">
					...
					<div class="form-group">
						<label>本文</label>
						<textarea id="admin-news-content" rows="4"
							placeholder="ここにニュースの詳細な本文を入力してください..."></textarea>
					</div>
	...
	<div id="cart-modal" class="modal-overlay">
		<div class="modal-content">
			...
			<div class="cart-total-area">
				<div>
					Total Amount: <span class="total-price">¥<span
						id="cart-total-modal">0</span></span>
				</div>
				<div
					style="margin-top: 10px; font-size: 14px; color: #ccc; border-top: 1px dashed #555; padding-top: 10px;">
					所持通貨 (MDP): <span id="cart-current-coin">0</span> CP ➔ <strong
						style="color: #3498db;">購入後: <span id="cart-after-coin">0</span>
						CP
					</strong>
				</div>
			</div>
